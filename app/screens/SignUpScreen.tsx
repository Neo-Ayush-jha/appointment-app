import EmailVarifyPopUp from "@/app/components/EmailVarifyPopUp";
import { signupUser } from "@/constants/api/User";
...
export default function SignUpScreen() {
  ...
  return (
    <ScrollView className=" bg-blue-100 h-full w-full  pt-16">
      <View>
        ...
        <View className="flex-col justify- items-center mt-md pt-[65px] gap-12">
