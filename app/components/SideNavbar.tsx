    ...
    >
      ...
      <View className="flex-1">
        ...
        >
          ...
          <Text className="ml-3 text-xl font-semibold text-gray-600">Home</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text className="ml-3 text-xl font-semibold text-gray-600">Note</Text>
        </TouchableOpacity>
      ...
      <View className="border-t border-gray-300 px-3 py-4">
        ...
        >
          <View className="bg-orange-200 p-2 rounded-xl ">
