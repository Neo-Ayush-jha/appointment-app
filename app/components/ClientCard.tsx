import { BadgeIndianRupeeIcon, Calendar, Calendar1Icon, CheckCircle2Icon } from 'lucide-react-native';
    ...
    <View className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 ">
      <View className="rounded-xl w-full py-6 px-4 bg-white flex-row items-center gap-4">
        ...
        <View className="flex-3 flex-col">
          <Text className="text-gray-800 text-2xl">Total Clients</Text>
      ...
      <View className="rounded-xl w-full py-6 px-4 bg-white flex-row items-center gap-4">
        <View className="p-6 rounded-full bg-purple-200">
          <Calendar size={40} color="#9333ea" />
        </View>
        <View className="flex-3 flex-col">
          <Text className="text-gray-800 text-2xl">Total Appointments</Text>
          <Text className="text-gray-950 text-3xl font-bold">34</Text>
        </View>
      </View>
      ...
      <View className="rounded-xl w-full py-6 px-4 bg-white flex-row items-center gap-4">
        ...
        <View className="flex-3 flex-col">
          <Text className="text-gray-800 text-2xl">Total Revenue</Text>
          <Text className="text-gray-950 text-3xl font-bold">34</Text>
        </View>
      </View>
    </View>
